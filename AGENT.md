...
| 凭据与工具 | `src/core/studio/`、`.data/user/config/studio/`、`config/templates/studio/` |
...
最新 Flow 规范为 `CF-FARP@0.7`，当前基座实现仍只声明 `CARTRIDGEFLOW-BASE@0.2 + CF-FARP@0.6 partial`。真实运行支持以 `config/base/BASE_IMPLEMENTATION.json` 为准；不得因为 v0.7 正文已经发布就声称交互节点或脚本安全能力已经实现。
...
- 最新 Flow 协议：`docs/protocol/CARTRIDGEFLOW_FLOW_AUTHORING_RUNTIME_PROTOCOL_v0.7.md`
- 当前运行实现快照：`docs/protocol/CARTRIDGEFLOW_FLOW_AUTHORING_RUNTIME_PROTOCOL_v0.6.md`
