...
3. worker 103 may start from a clean root baseline. Worker 104 is rejected pending a narrow fix: its Analyzer projection must distinguish “plan compiled” from “Base runnable/publishable” while `CF-FARP@1.0` remains draft/unsupported. They have no shared write paths after that fix is accepted.
