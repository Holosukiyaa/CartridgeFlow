...
- `cartridgeflow-protocols/protocol-source.sqlite` 的 `current:protocol/release-envelope/1/specification.md`：CF-CRE@1 原本。
- `cartridgeflow-protocols/protocol-source.sqlite` 的 `current:protocol/flow-authoring/1.0/` artifacts：CF-FARP@1.0 原本。
