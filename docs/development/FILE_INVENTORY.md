...
| Creator authoring | `src/core/studio/`, `src/core/llm/` | `authoring_service.py`, `creator_discovery.py` (strict creator-safe direction and source-candidate discovery), `creator_runtime_bridge.py` |
