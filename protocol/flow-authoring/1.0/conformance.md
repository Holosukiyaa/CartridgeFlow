# CF-FARP@1.0 - Conformance requirements
...
- the Manifest declares `CARTRIDGEFLOW-BASE@0.2` and `CF-FARP@1.0`;
...
The certification label is `cf-farp-1-0-certified`. It is issued only for the exact cartridge revision, Base implementation, capability set and test environment named in the report. Changing any covered authoring fact invalidates certification.
