...
This release preserves the CF-FARP@1.1 topology and executable-contract
semantics. Its only new trusted boundary is CF-TUNING@1.1 for immutable AI
authoring facts; see `tuning-and-releases.md`. No ordinary user runtime is
