...
class ProtocolV03FlowContractTest(unittest.TestCase):
    ...
    def test_v03_certification_is_blocked_after_runtime_support_removal(self):
    ...
    def test_runtime_resume_capability_remains_available_but_v03_is_not_executable(self):
        ...
        self.assertIn("runtime_resume_after_user_input", load_base_implementation(ROOT)["capabilities"])
        self.assertFalse(report["ok"])
