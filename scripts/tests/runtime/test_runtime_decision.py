...
class RuntimeDecisionTests(unittest.TestCase):
    def test_mock_decision_writes_structured_envelope(self):
        state_doc = {"context": {"store": {"context_pack": {"goal": "build short drama"}}}}
        run = {"inputs": {}, "run_id": "run_test", "cartridge_id": "test.runtime.decision"}
        envelope = {
            "schema": "decision_envelope.v1",
            "status": "resolved",
            "summary": "Ready.",
    ...
    def test_needs_user_input_returns_pause_signal(self):
        state_doc = {"context": {"store": {"context_pack": {"goal": "build short drama"}}}}
        run = {"inputs": {}, "run_id": "run_test", "cartridge_id": "test.runtime.decision"}
        envelope = {
            "schema": "decision_envelope.v1",
    ...
    def test_run_level_interaction_mock_requests_user_input(self):
        state_doc = {"context": {"store": {"context_pack": {"goal": "build short drama"}}}}
        run = {
            "inputs": {},
            "run_id": "run_test",
            "cartridge_id": "test.runtime.decision",
    ...
    def test_run_level_blocked_mock_fails_decision(self):
        state_doc = {"context": {"store": {"context_pack": {"goal": "build short drama"}}}}
        run = {
            "inputs": {},
            "run_id": "run_test",
    ...
    def test_invalid_decision_output_blocks(self):
        state_doc = {"context": {"store": {"context_pack": {"goal": "build short drama"}}}}
        run = {"inputs": {}, "run_id": "run_test", "cartridge_id": "test.runtime.decision"}
    ...
    def test_live_decision_unwraps_common_outer_key(self):
        raw = """
        {
          "decision_envelope": {
            "status": "resolved",
    ...
    def test_parse_decision_envelope_accepts_smart_quotes(self):
        raw = """
        {
          "schema": "decision_envelope.v1",
          "status": "needs_user_input",
    ...
    def test_live_needs_user_input_hoists_payload_question_and_uses_contract(self):
        raw = """
        {
          "schema": "decision_envelope.v1",
          "status": "needs_user_input",
    ...
    def test_run_level_resolved_mock_uses_offline_decision_sample(self):
        state_doc = {"context": {"store": {"context_pack": {"goal": "build short drama"}}}}
        run = {
            "inputs": {},
            "run_id": "run_test",
