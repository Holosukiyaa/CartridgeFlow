...
class BuiltinMcpRegistry:
    ...
    def __init__(
        ...
        *,
        ...
        worker_journal_dir: str | Path | None = None,
    ):
        ...
        self._worker_journal_dir = Path(worker_journal_dir).resolve() if worker_journal_dir else None
    ...
    def for_manifest(
        ...
        return cls(
            ...
            worker_journal_dir=worker_journal_dir,
        )
