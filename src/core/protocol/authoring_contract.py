...
TRUSTED_NODE_AUTHORING_PROTOCOL = {"id": "CF-TUNING", "version": "1.4"}
CAPABILITY_AUTHORING_PROTOCOL = {"id": "CF-TUNING", "version": "1.5"}
_SUPPORTED_AUTHORING_PROTOCOLS = (CAPABILITY_AUTHORING_PROTOCOL, TRUSTED_NODE_AUTHORING_PROTOCOL, AUTHORING_PROTOCOL, LEGACY_AUTHORING_PROTOCOL)
