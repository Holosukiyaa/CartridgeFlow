...
ERROR_CATALOG: dict[str, ErrorSpec] = {
    ...
    "AI_AUTHORING_MODEL_UNBOUND": ErrorSpec("authoring", "创作工作台没有绑定可用的 AI 模型。", False, True, ("configure_provider", "switch_provider"), 409),
    "AI_AUTHORING_MODEL_TIMEOUT": ErrorSpec("authoring", "AI 创作服务在限定时间内没有响应。", True, True, ("retry_node", "switch_provider"), 504),
    "AI_AUTHORING_MODEL_FAILED": ErrorSpec("authoring", "AI 创作服务没有返回可审阅的变更。", True, True, ("retry_node", "switch_provider"), 502),
