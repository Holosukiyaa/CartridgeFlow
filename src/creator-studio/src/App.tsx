...
export default function App() {
  ...
  return <main>
    ...
    <JourneyCanvas graph={creator.journey_graph} onSelectStep={(id) => { const step = creator.semantic_steps.find((item) => item.id === id); if (step) { setSelectedStep(step.id); setStepIntent(step.intent) } }} />
