...
check(workspace.includes('AI 管家') && workspace.includes('仍然不是终稿'), 'Creator never treats an accepted revision as final user intent')
...
check(canvas.includes('NODE_WIDTH = 288') && canvas.includes('NODE_HEIGHT = 202'), 'Creator nodes retain the approved final-prototype visual weight')
